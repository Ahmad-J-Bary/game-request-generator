...
import { storageService } from '@grq/core/services/storage.service';
...
const LIGHT_DEFAULT_COLORS: ColorSettings = {
  levelBonus: 'rgb(254, 249, 195)',      // Light yellow for bonus levels (requested)
  ...
  headerColor: 'rgb(144, 200, 144)',    // Light green for headers
  dataRowColor: 'rgb(150, 150, 150)',   // Gray for data rows (requested)
